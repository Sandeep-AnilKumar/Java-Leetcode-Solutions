...
public class SplitConcatenatedString {
	...
	public static void main(String[] args) {
		SplitConcatenatedString split = new SplitConcatenatedString();
		String[] strs = {"lc", "love", "ydc"};
		System.out.println("The maximum split concatenated string is := " + split.splitLoopedString(strs));
	}
