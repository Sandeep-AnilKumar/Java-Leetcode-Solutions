...
An arrow canShip be shot up exactly vertically from different points along the
x-axis. A balloon with xstart and xend bursts by an arrow shot at x if xstart =
x = xend. There is no limit to the number of arrows that canShip be shot. An arrow
